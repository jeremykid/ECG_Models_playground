...
from dataset_mimic_iv import ECGDataset
...
SUPERVISED_MODEL_CKPT_PATH = "../models/checkpoints/"
...
def finetune(args):
    ...
    wandb.init(project="HuBert_ECG", group="MIMIC_IV 1256 supervised") #entity="my-entity", 
    ...
    train_set = ECGDataset(
        ...
        ecg_dir_path='/data/padmalab_external/special_project/physionet.org/files/mimic-iv-ecg/1.0/',
    ...
    if args.resume_finetuning:
        ...
        config = HuBERTECGConfig(
            ...
            feat_proj_dropout=0.1 + DROPOUT_DYNAMIC_REG_FACTOR * args.model_dropout_mult,
            final_dropout=0.1 + DROPOUT_DYNAMIC_REG_FACTOR * args.model_dropout_mult,    
        ) # + other default params
        print ('feat_proj_dropout:', 0.1 + DROPOUT_DYNAMIC_REG_FACTOR * args.model_dropout_mult)
        ...
        for ecg, attention_mask, labels in tqdm(train_dl, total=len(train_dl)):
            ...
            if global_step % args.val_interval == 0:
                ...
                if val_loss <= best_val_loss - MINIMAL_IMPROVEMENT: 
                    ...
                    checkpoint_name = f"hubert_{args.train_iteration}_finetuned_{wandb.run.id}.pt"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train Hubert-ECG MIMIC")
    ...
    parser.add_argument(
        ...
        choices=["f1_score", "recall", "precision", "specificity", "auroc", "accuracy"]
    )
